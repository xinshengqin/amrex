...
subroutine advect_host(time, lo, hi, &
     &            uin , ui_lo, ui_hi, &
     &            uout, uo_lo, uo_hi, &
     &            vx  , vx_lo, vx_hi, &
     &            vy  , vy_lo, vy_hi, &
     ...
     &            flxz, fz_lo, fz_hi, &
     &            dx,dt &
                ) bind(C, name="advect_host")
  use mempool_module, only : bl_allocate, bl_deallocate
  use compute_flux_module, only : compute_flux_3d_host
  ...
  call compute_flux_3d_host(lo, hi, dt, dx, &
                       uin, ui_lo, ui_hi, &
                       vx, vx_lo, vx_hi, &
                       vy, vy_lo, vy_hi, &
                       vz, vz_lo, vz_hi, &
