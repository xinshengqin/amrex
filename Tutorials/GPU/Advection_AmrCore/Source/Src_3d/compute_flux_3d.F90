...
contains
  ...
  subroutine compute_flux_3d_host(lo, hi, dt, dx, &
                             phi,ph_lo,ph_hi, &
                             umac,  u_lo,  u_hi, &
                             vmac,  v_lo,  v_hi, &
                             wmac,  w_lo,  w_hi, &
    ...
    use slope_module, only: slopex_host, slopey_host, slopez_host
  ...
  end subroutine compute_flux_3d_host
