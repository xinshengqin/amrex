module slope_module
  ...
  public :: slopex_host, slopey_host, slopez_host
...
! Below are host subroutines
  subroutine slopex_host(lo, hi, &
                    q, qlo, qhi, &
                    dq, dqlo, dqhi)
  ...
  end subroutine slopex_host


  subroutine slopey_host(lo, hi, &
                    q, qlo, qhi, &
                    dq, dqlo, dqhi)
  ...
  end subroutine slopey_host

  subroutine slopey_doit_host(lo, hi, &
                         q, qlo, qhi, &
                         dq, dqlo, dqhi, &
                         dsgn, dlim, df, dcen, ddlo, ddhi)
  ...
  end subroutine slopey_doit_host


  subroutine slopez_host(lo, hi, &
                    q, qlo, qhi, &
                    dq, dqlo, dqhi)
  ...
  end subroutine slopez_host

  subroutine slopez_doit_host(lo, hi, &
                         q, qlo, qhi, &
                         dq, dqlo, dqhi, &
                         dsgn, dlim, df, dcen, ddlo, ddhi)
  ...
  end subroutine slopez_doit_host
